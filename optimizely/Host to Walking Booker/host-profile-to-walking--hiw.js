// tracking stuff
var walkingLandPxl = '/pxl/v1?event_type=pageview&event_data=pageload|1&page_name=profile_host_walking_how_it_works',
 walkingClickDates = '/pxl/v1?event_type=click&event_data=name|select_dates; type|button&page_name=profile_host_walking_how_it_works',
 walkingClickRRAndDatesShow = '/pxl/v1?event_type=display&event_data=name|calendar; type|overlay&page_name=profile_host_walking_how_it_works',
 walkingClickRR = '/pxl/v1?event_type=click&event_data=name|request_my_walk; type|button&page_name=profile_host_walking_how_it_works',
 // walkingSignupModalShown = '',
 walkingContinueSignupButton = '/pxl/v1?event_type=submit&event_data=name|signup;result|success or result|error; type_button&page_name=profile_host_walking_how_it_works',
 walkingFacebookSignupButton = '/pxl/v1?event_type=click&event_data=name|signup_connect_with_facebook; type|button&page_name=profile_host_walking_how_it_works',
 // walkingLoginModalShown = '',
 walkingContinueLoginButton = '/pxl/v1?event_type=submit&event_data=name|login;result|success or result|error; type|button&page_name=profile_host_walking_how_it_works',
 walkingFacebookLoginButton = '/pxl/v1?event_type=click&event_data=name|login_connect_with_facebook; type|button&page_name=profile_host_walking_how_it_works',
 walkingDatesDone = '/pxl/v1?event_type=user_selection&event_data=name|select_dates; type|overlay&page_name=profile_host_walking_how_it_works';
